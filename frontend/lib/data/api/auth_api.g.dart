...
class _AuthApi implements AuthApi {
  ...
  @override
  Future<SignupResponseDto> signup(LocalSignupDto dto) async {
  ...
  @override
  Future<LoginResponseDto> login(LocalLoginDto dto) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<KakaoLoginResponseDto> kakaoLogin(KakaoLoginDto dto) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(dto.toJson());
    final _options = _setStreamType<KakaoLoginResponseDto>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/auth/login/kakao',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late KakaoLoginResponseDto _value;
    try {
      _value = KakaoLoginResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
