...
class AbilityButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final total = ability.totalCooldownSec;
    ...
    // Calculate progress (1.0 when ready, 0.0 when full cooldown? Or reverse?)
    // Gauge usually fills up as cooldown recovers.
    // remain: total -> 0.
    ...
    return GestureDetector(
      ...
      child: Column(
        ...
        children: [
          ...
          if ((ability.cooldownSpeed) > 1.0 && !isReady)
            Padding(
              padding: const EdgeInsets.only(top: 4),
              child: Text(
                '심박 가속 x${ability.cooldownSpeed.toStringAsFixed(2)}',
